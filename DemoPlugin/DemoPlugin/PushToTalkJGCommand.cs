namespace Loupedeck.DemoPlugin
{
    ...
    public class PushToTalkJGCommand : PluginDynamicCommand
    {
        private const int LOCAL_IPC_PORT = 5006;
        private UdpClient udpClient;

        public PushToTalkJGCommand()
            : base(displayName: "PTT: Whisper JG", description: "Push to talk only to Jungler", groupName: "Tactical Voice")
        {
        ...
        protected override Boolean ProcessButtonEvent2(String actionParameter, DeviceButtonEvent2 buttonEvent)
        {
            ...
            {
                byte[] data = Encoding.UTF8.GetBytes("PTT_JG_START");
