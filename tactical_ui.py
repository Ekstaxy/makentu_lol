...
class TacticalApp(tk.Tk):
    def __init__(self):
        ...
        self.frames = {}
        for ScreenClass in (HomeScreen, ConnectScreen, RoleScreen, MyHeroScreen, EnemyHeroScreen, DashboardScreen):
...
class HomeScreen(tk.Frame):
    ...
    def show_intro(self):
        ...
        # Scrollable text (for long intro)
...
class RoleScreen(tk.Frame):
    ...
    def on_show(self):
        # Restore previous choice when coming back
        if selected_role in self.role_buttons:
            self.select_role(selected_role)
        else:
            for _, (btn, orig_color) in self.role_buttons.items():
                btn.configure(bg=orig_color, fg="#fff", state="normal")
            self.next_btn.configure(bg="#333", fg="#666", state="disabled", command=None)
...
class MyHeroScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        back_btn = tk.Button(
            ...
            padx=12,
            pady=6,
            command=lambda: controller.show_frame("RoleScreen"),
        )
        back_btn.place(x=18, y=18, anchor="nw")
    ...
    def on_show(self):
        ...
        # Restore previous choice when coming back
        if selected_my_hero in self.hero_buttons:
            self.select_hero(selected_my_hero)
        else:
            self.next_btn.configure(bg="#333", fg="#666", state="disabled", command=None)
...
class EnemyHeroScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        back_btn = tk.Button(
            ...
            padx=12,
            pady=6,
            command=lambda: controller.show_frame("MyHeroScreen"),
        )
        back_btn.place(x=18, y=18, anchor="nw")
...
class DashboardScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        back_btn = tk.Button(
            ...
            padx=12,
            pady=6,
            command=lambda: controller.show_frame("EnemyHeroScreen"),
        )
        back_btn.place(x=18, y=18, anchor="nw")
